...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -145, 216, 712))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit_time_delay.setText(_translate("Dialog", "2200"))
        ...
        self.lineEdit_amplitude_am.setText(_translate("Dialog", "5"))
        self.label_text_coefficient_am.setText(_translate("Dialog", "Коэффициент"))
        self.lineEdit_coefficient_am.setText(_translate("Dialog", "3"))
