...
class GuiProgram(Ui_Dialog):
    ...
    def research_resistance_noise(self):
        ...
        # Диапазон шума (от -10 дБ до +10 дБ с шагом 1)
        noise_range = np.arange(-10, 10, 1)
        ...
        for step_noise in noise_range:
            probabilities_am.append(process_signal('AM', step_noise))
            probabilities_fm2.append(process_signal('FM2', step_noise))
            probabilities_mchm.append(process_signal('MCHM', step_noise))
